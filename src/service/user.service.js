const { getAllUserDB, getByIdUserDB, createUserDB, upUserDB, deleteUserDB, getByIdEmail } = require('../repository/user.repository');
...
module.exports = { getAllUser, getByIdUser, createUser, upUser, deleteUser, getAuth };